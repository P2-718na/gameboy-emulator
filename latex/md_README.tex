...
Documentation is automatically generated for the {\ttfamily Gameboy} library. The documentation for the latest release is available \mbox{[}here\mbox{]}(TODO).\hypertarget{md_README_autotoc_md17}{}\doxysubsection{On code clarity}\label{md_README_autotoc_md17}

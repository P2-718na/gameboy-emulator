...
Interrupts and timers   &\PBS\centering 🟢   &CPU interrupts and timer have been implemented. Interrupts do pass Blargg\textquotesingle{}s tests; timers do not (see Testing).    \\\cline{1-3}
...
The emulator library does not use any external dependency, apart from the standard library. To build the standalone program, however, you will need\+:
\begin{DoxyItemize}
...
To learn how to use the {\ttfamily Gameboy} library, please refer to the \href{https://p2-718na.github.io/gameboy-emulator/html/classgb_1_1Gameboy.html}{\texttt{ documentation}}.\hypertarget{md_README_autotoc_md8}{}\doxysubsection{Building on different systems}\label{md_README_autotoc_md8}
...
\end{longtabu}
\hypertarget{md_README_autotoc_md12}{}\doxysection{Testing}\label{md_README_autotoc_md12}
In this project I have implemented a comprehensive test routine by combining three main methods\+:


\begin{DoxyEnumerate}
\item {\bfseries{Unit Tests}},
\item {\bfseries{Test ROMs}}, and
\item {\bfseries{Runtime Assertions}}.
\end{DoxyEnumerate}

For detailed information about the testing process, please see \mbox{\hyperlink{md_TESTING}{TESTING.md}}.\hypertarget{md_README_autotoc_md13}{}\doxysection{Additional notes}\label{md_README_autotoc_md13}

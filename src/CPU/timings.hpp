...
// Gotta write it this way because array designators were removed after C++99.
inline void CPU::initTimings() {
  auto& _ = INSTRUCTION_TIMINGS;
...
inline void CPU::initTimingsCB() {
  auto& _ = CB_INSTRUCTION_TIMINGS;
